			...
			<div class="col-md-12">
				<div class="color-box">
					...
					<div class="controls">
						...
						{{ Form::text('city',null,array( 'disabled','id'=>'city', 'class' => 'form-control')) }}	
					</div>
					<div class="controls">
						@if($errors->has('state'))
							...
							@endforeach
						@endif
						<label class="text-muted" for="state" >State</label>
						{{ Form::text('state',null,array( 'disabled','id'=>'state', 'class' => 'form-control')) }}	
					</div>
				</div>
			</div>
		</div>
