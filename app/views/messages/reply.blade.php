...
<form class="inbox-compose form-horizontal" id="fileupload" action="#" method="POST" enctype="multipart/form-data">
	...
	<div class="inbox-control-group mail-to">
		...
		<div class="controls controls-to">
			<input type="text" class="m-wrap span12" name="to" value="fiona.stone@arthouse.com, lisa.wong@pixel.com, jhon.doe@gmail.com">
	...
	<div class="inbox-control-group input-cc">
		<a href="javascript:;" class="close"></a>
		<label class="control-label">Cc:</label>
		<div class="controls controls-cc">
			<input type="text" name="cc" class="m-wrap span12" value="jhon.doe@gmail.com, kevin.larsen@gmail.com">
		</div>
	</div>
	...
	<div class="inbox-control-group">
		...
		<div class="controls">
			<input type="text" class="m-wrap span12" name="subject" value="Urgent - Financial Report for May, 2013">
		</div>
	</div>
	<div class="inbox-control-group">
		<div class="controls-row">
			...
			<div id="reply_email_content_body" class="hide">
				...
				<blockquote>
					...
					<br><br>
					Consectetuer adipiscing elit, sed diam nonummy nibh euismod exerci tation ullamcorper suscipit lobortis nisl ut aliquip ex ea commodo consequat.
					<br>
					<br>
					All the best,<br>
