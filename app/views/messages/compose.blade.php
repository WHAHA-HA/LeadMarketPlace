...
<form class="inbox-compose form-horizontal" id="fileupload" action="{{url('messages/compose')}}" method="POST" enctype="multipart/form-data">
    ...
    <div class="inbox-compose-btn">
		<button name="send" value="send" type="submit" class="btn blue"><i class="icon-check"></i>Send</button>
	...
	<div class="inbox-control-group mail-to">
		...
		<div class="controls controls-to">			
			{{Form::select('to',$recipients,isset($message)?$message->to:NULL,array('data-placeholder'=>'Select Recipients', 'class' => 'chosen span11'))}}
	...
	<div class="inbox-control-group">
		...
		<div class="controls">
			<input type="text" class="m-wrap span12" name="subject" value="{{isset($message)?$message->subject:""}}">
		</div>
	</div>
	<div class="inbox-control-group">
		<textarea class="span12 inbox-editor inbox-wysihtml5 m-wrap" name="message" rows="12">{{isset($message)?$message->message:""}}</textarea>
	</div>
