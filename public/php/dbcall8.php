...
// /Users/ivanroth/workspace/leadcliq-platform/public/php//phayes/geophp
...
$sql = "SELECT *, AsWKB(SHAPE) AS wkb FROM gis_cities where namelsad10 LIKE '" .$city. "%' ORDER BY size DESC LIMIT 1;";
